<?php 
	$events = EventPage::create_fromobject($page);
	$paginator = new Paginator($input->pageNum, $pages->find("template=event")->count, $page->fullURL->getUrl(), $page->name);
...
<div class="container page">
    ...
    <?php foreach ($events->get_events($limit) as $event) : ?>
        <div class="row">
            <div class="col-md-2">
                <a href="<?= $event->url; ?>">
