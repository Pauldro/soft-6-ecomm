            ...
            <div class="row">
                ...
                <div class="col-sm-6">
                    <div class="panel panel-info">
                      ...
                      <div class="panel-body">
                         <p class="col-sm-12"><a href="#">Change your password</a></p>
                         <p class="col-sm-12"><a href="<?= $pages->get('/user/redir/')->url . '?action=logout'; // TODO fix url ?>">Log out of your account</a></p>
                      </div>
                    </div>
                </div>
            </div>
